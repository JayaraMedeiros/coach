...
<html>
    ...
    <body>
        ...
        <div id="edit-questionario" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.questionario}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.questionario}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.questionario}" method="PUT">
                <g:hiddenField name="version" value="${this.questionario?.version}" />
                <fieldset class="form">
                    <f:all bean="questionario"/>
                </fieldset>

...
<html>
    ...
    <body>
        ...
        <div id="edit-treino" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.treino}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.treino}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.treino}" method="PUT">
                <g:hiddenField name="version" value="${this.treino?.version}" />
                <fieldset class="form">
                    <f:all bean="treino"/>
                </fieldset>

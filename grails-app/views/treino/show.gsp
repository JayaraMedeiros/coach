...
<html>
    ...
    <body>
        ...
        <div id="show-treino" class="content scaffold-show" role="main">
            ...
            <f:display bean="treino" />
            <g:form resource="${this.treino}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.treino}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="list-exercicio" class="content scaffold-list" role="main">
            <h1><span class="glyphicon glyphicon-flash" aria-hidden="true"></span> <g:message code="default.list.label" args="[entityName]" /></h1>
            ...
            <f:table collection="${exercicioList}" />

            <div class="pagination">
                <g:paginate total="${exercicioCount ?: 0}" />
            </div>
        </div>
        </div>

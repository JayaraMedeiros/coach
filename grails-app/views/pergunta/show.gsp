...
<html>
    ...
    <body>
        ...
        <div id="show-pergunta" class="content scaffold-show" role="main">
            ...
            <f:display bean="pergunta" />
            <g:form resource="${this.pergunta}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.pergunta}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
